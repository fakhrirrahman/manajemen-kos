            ...
            <div className="flex-shrink-0 flex items-center">
              <Link href="/" className="flex items-center">
                ...
                <span className="ml-3 text-xl font-bold text-gray-900">
                  Kosan<span className="text-indigo-600">Plus</span>
                </span>
              </Link>
            </div>
          ...
          <div className="md:hidden bg-white shadow-lg">
            ...
            <div className="pt-4 pb-3 border-t border-gray-200 px-5">
              <div className="flex items-center justify-between">
                <Link
                  href="/login"
                  className="text-gray-900 hover:text-indigo-600 px-3 py-2 rounded-md text-base font-medium"
                >
                  Sign In
                </Link>
                <Link
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block">Modern Kosan</span>
              <span className="block text-indigo-600">Management System</span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Simplify your boarding house management with our all-in-one solution. Manage tenants,
              payments, and maintenance effortlessly.
            </p>
            <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div className="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
                ...
                <Link
                  href="/demo"
                  className="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-indigo-700 bg-indigo-100 hover:bg-indigo-200 md:py-4 md:text-lg md:px-10"
                >
                  Live demo
                </Link>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Everything you need to manage your kosan
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our platform provides all the tools to efficiently run your boarding house business.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description:
                    "Easily track all your tenants, contracts, and room assignments in one place.",
                  icon: (
                    <svg
                      className="h-6 w-6"
                      xmlns="http://www.w3.org/2000/svg"
                ...
                },
                {
                  ...
                  description:
                    "Automated payment reminders and tracking to ensure timely rent collection.",
                  icon: (
                    <svg
                      className="h-6 w-6"
                      xmlns="http://www.w3.org/2000/svg"
                ...
                },
                {
                  ...
                  description:
                    "Tenants can submit maintenance requests that you can track and manage.",
                  icon: (
                    <svg
                      className="h-6 w-6"
                      xmlns="http://www.w3.org/2000/svg"
                ...
                },
                {
                  name: "Room Inventory",
                  description:
                    "Keep track of room conditions, furniture, and equipment.",
                  icon: (
                    <svg
                      className="h-6 w-6"
                      xmlns="http://www.w3.org/2000/svg"
                ...
                },
                {
                  ...
                  description:
                    "Access your kosan management system from anywhere on any device.",
                  icon: (
                    <svg
                      className="h-6 w-6"
                      xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="bg-indigo-700">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
            <span className="block">Ready to transform your kosan management?</span>
          </h2>
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="col-span-2">
              ...
              <p className="mt-4 text-base text-gray-300">
                The modern solution for boarding house management, helping owners streamline their
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2023 KosanPlus. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
